...
#define ADVANCE_VM(bytes) pCurrentFieldScriptActor->mCC_scriptPC += bytes
...
void OP_MAKE_INVISIBLE_ACTIVE();
void OP_MAKE_VISIBLE_BY_ID();
void OP_MAKE_INVISIBLE_BY_ID();
void OP_WAIT();
void OP_RESET_CHARACTER();
void OP_ENABLE_VM_FOR_CHARACTER();
void OP_DELETE_ENTITY();
void DISABLE_DIALOG_ACTIVATION();
...
void OP_SET_VAR_OR();
void OP_SET_VAR_XOR();
void OP_SET_VAR_SHIFTLEFT();
void OP_SET_VAR_SHIFTRIGHT();
...
void OP_SET_ENCOUNTER_DATA(); // 0x8008E85C
void OP_F9();
void OP_FB();
void OP_FC();
...
void OPX_13();
void OPX_15();
void OPX_ROTATE_CHARACTER_TO_CHARACTER();
...
void OP_START_CINEMATIC();
void OP_OPEN_NORMAL_MENU();
...
void OP_SET_LINK_OT(); 
void OPX_6B();
void OPX_DEBUG_PRINT_FLAG_VALUE();
void OPX_7F();
void OPX_80();
void OPX_81();
void OPX_82();
