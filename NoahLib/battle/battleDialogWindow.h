...
struct sBattleDialogWindow {
    ...
    std::array<std::array<POLY_FT4, 2>, 2> m140_poly1;
    std::array<std::array<POLY_FT4, 2>, 2> m1E0_poly2;
    std::array<std::array<POLY_FT4, 2>, 2> m280_poly3;
    std::array<std::array<POLY_FT4, 2>, 2> m320_poly4;
