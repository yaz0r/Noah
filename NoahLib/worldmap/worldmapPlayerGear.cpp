...
int createWorldmapGear(sWorldmapStateEntry* param_1, int param_2)
{
    ...
    if (uVar2 < 8) {
        ...
        case 6:
            ...
            if (gameState.m1D34_currentParty[param_2] == 0xFF || gameState.m26C[gameState.m1D34_currentParty[param_2]].m78_partyData_gearNum == -1) {
                return 3;
            }
            else {
            ...
            break;
        case 1:
            if (gameState.m26C[gameState.m1D34_currentParty[param_2]].m78_partyData_gearNum == -1) {
                return 3;
            }
            else {
                createGearSpriteActor(param_1, param_2);
